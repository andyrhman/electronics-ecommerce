...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-blue-500 hover:border-blue-500 border-1 font-normal bg-rose-500 text-white hover:bg-white hover:scale-110 hover:text-rose-500 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Beli Sekarang
    </button>
  );

...
const AddToCartSingleProductBtn = ({ product, quantityCount } : SingleProductBtnProps) => {
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-gray-300 border-1 font-normal bg-white text-rose-500 hover:bg-rose-500 hover:text-white hover:border-blue-500 hover:scale-110 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Add to cart
    </button>
  );

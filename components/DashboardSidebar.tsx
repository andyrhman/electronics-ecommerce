...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-rose-500 h-full max-xl:w-full">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-rose-600 cursor-pointer items-center py-6 pl-5 text-xl text-white">

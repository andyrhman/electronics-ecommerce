...
const SingleReview = () => {
  return (
    <article className="w-[900px] mx-auto py-10 max-[1000px]:w-[700px] max-[750px]:w-[90%]">
      ...
      <a
        href="#"
        className="block mb-5 text-sm font-medium text-rose-600 hover:underline dark:text-rose-500"
      >
        Read more
      </a>
      <aside>
        ...
        <div className="flex items-center mt-3">
          ...
          <a
            href="#"
            className="ps-4 text-sm font-medium text-rose-600 hover:underline dark:text-rose-500 border-gray-200 ms-4 border-s md:mb-0 dark:border-gray-600"
          >
            Report abuse
          </a>
        </div>

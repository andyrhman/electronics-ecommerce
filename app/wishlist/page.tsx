    ...
    <div className="bg-white">
      ...
      {wishlist && wishlist.length === 0 ? (
        <h3 className="text-center text-4xl py-10 text-black max-lg:text-3xl max-sm:text-2xl max-sm:pt-5 max-[400px]:text-xl">
          Tidak ada item yang ditemukan dalam Wishlist
        </h3>
      ) : (
          ...
          <div className="overflow-x-auto">
            <table className="table text-center">
              <thead>
                <tr>
                  <th></th>
                  <th className="text-accent-content">Gambar</th>
                  <th className="text-accent-content">Nama</th>
                  <th className="text-accent-content">Status Stok</th>
